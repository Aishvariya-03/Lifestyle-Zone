...
if(isset($_POST['delete']))
    {
        ...
        $delete_id = $_GET['trash_trainer'];
        //delete query
        $delete_query = "DELETE FROM `trainer_details` WHERE trainer_id = '$delete_id'";
        $result_delete = $conn->query($delete_query);
        if($result_delete)
        {
            echo"<script>alert('Trainer details deleted successfuly')</script>";
...
<body>
    <form action="" method="post">
        <div id="confirmationPopup" class="confirmation-popup text-center">
            ...
            <h3 class="text-danger m-5">Are you sure you want to delete trainers details?</h3>
