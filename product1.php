...
<section id="header">
    ...
    <div>
      <ul id="navbar">
        <li ><a class="active" href="product1.php">Product</a></li>
        <li ><a href="admin_home.php"><i class="fa-solid fa-rotate-left"></i></a></li>
    ...
    <section id="product1" class="section-p1">
        ...
        if ($result->num_rows > 0) {
            while($row = $result->fetch_assoc()) {
                ...
                echo "<a href='product1.php?add_to_cart=".$row["pro_id"]."' class='btn'>Add to Cart</a><style>a.btn{background-color:darkseagreen; color:black; font-weight:600; margin-left:10px;}a.btn:hover{background-color:seagreen;color:azure;font-weight:600;}</style>";
                echo "<a href='product_details.php?prod_id=".$row["pro_id"]."' class='btn'>View More</a><style>a.btn{background-color:darkseagreen; color:black; font-weight:600; margin-left:10px;}a.btn:hover{background-color:seagreen;color:azure;font-weight:600;}</style>";
                echo "</form>";
                echo "</div>";
                echo "</div>";
            }
    ...
    <div class="col-md-2 bg-secondary p-0">
            <ul class="navbar-nav me-auto text-center">
                ...
                while($row = mysqli_fetch_assoc($result_select))
                {
                    ...
                    <a href='product1.php?brand=$brand_id' class='nav-link text-light'>".$row['brand_title']."</a>
                </li>";
                }
                ?>
            </ul>
            ...
            <ul class="navbar-nav me-auto text-center">
                ...
                while($row = mysqli_fetch_assoc($result_select))
                {
                    ...
                    echo "<li class='nav-item '>
                    <a href='product1.php?category=$category_id' class='nav-link text-light'>".$row['category_title']."</a>
                </li>";
                }
                ?>
            </ul>
